(function () {
    ...
    var PegaChatConfig = {
        "ChannelId": "bot2603ddf4b14344bb9591d1b8437c046a",
        "HelpConfigurationName": "bot2603ddf_legacy",
        "PegaSSAHelpButtonText": "Need Help?",
        "PegaApplicationName": "CSSelfService",
        "PegaServerURL": "https://lab0186.lab.pega.com/prweb/PRChat/app/CSSelfService_9938",
        "SSAWorkClass": "Work-Channel-Chat",
        "ProactiveChatClass": "PegaCA-Work-ProactiveChat",
        "CobrowseToken": "5788cb21939cde52102efcba",
        "CoBrowseServerHostURL": "https://us.cobrowse.pega.com",
        "ProactiveNotificationEnabled": "false",
        "ProactiveServiceURL": "https://lab0186.lab.pega.com/prweb/PRRestService/CSSelfServiceNBA/V1/Container",
    ...
    function DOMContentLoadedHandler() {
        ...
        if (PegaChatConfig.ProactiveNotificationEnabled == "true" && sessionStorage.getItem("ProactiveOffered") != "true") {
            ...
            xhttp.send('{"CustomerID" : "' + getCookie("ContactID") + '", "AccountNumber" : "' + getCookie("AccountNumber") + '"}');
        }
    ...
    function displayLauncher() {
        ...
        if (sessionStorage.getItem("BotStarted")) {
            ...
            var $launcher = appendElement("div", PegaChatConfig.PegaSSAHelpButtonText, { id: "launcher" });
